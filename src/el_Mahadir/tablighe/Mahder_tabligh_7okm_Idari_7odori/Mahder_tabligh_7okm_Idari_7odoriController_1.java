 ...
 */
package el_Mahadir.tablighe.Mahder_tabligh_7okm_Idari_7odori;
 ...
 */
public class Mahder_tabligh_7okm_Idari_7odoriController_1 implements Initializable {
    ...
    private void printTekHodor() throws JRException {
        ...
        switch (choose_تبليغ.getText()) {
            case "محضر تبليغ حكــم إداري حضــوري":
                is = this.getClass().getResourceAsStream("/el_Mahadir/tablighe/Mahder_tabligh_7okm_Idari_7odori/Mahder_tabligh_7okm_Idari_7odori.jrxml");
                break;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_7okm_Idari_7odoriController_1.class.getName()).log(Level.SEVERE, null, ex);
