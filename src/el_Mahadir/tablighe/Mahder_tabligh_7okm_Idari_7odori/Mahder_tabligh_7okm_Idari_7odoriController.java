 ...
 */
public class Mahder_tabligh_7okm_Idari_7odoriController implements Initializable {
...
//                ps.setString(3, "محضـر تبليــغ حكم حضـوري");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_7okm_Idari_7odoriController.class.getName()).log(Level.SEVERE, null, ex);
        }
