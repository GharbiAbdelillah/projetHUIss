 ...
 */
public class Mahder_tabligh_7okm_ghiyabiController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_7okm_ghiyabiController.class.getName()).log(Level.SEVERE, null, ex);
        }
