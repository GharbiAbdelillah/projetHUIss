 ...
 */
package el_Mahadir.tablighe.Mahder_tabligh_7okm_ghiyabi;
 ...
 */
public class Mahder_tabligh_7okm_ghiyabiController_1 implements Initializable {
    ...
    private void update_mahderTaklif(ActionEvent event) throws SQLException, JRException {
        ...
        String sql = "update tabligh set mahkama=? , classe=? , date=? ,num_fahres = ? ,num_jadwal = ? ,person=? ,avocat=? ,lieu_person=? ,suspect=? where num_file='" + tf_رقم_الملف.getText() + "' and num_Annee='" + tf_رقم_العام.getText() + "'";
    ...
    private void printTekHodor() throws JRException {
        ...
        switch (choose_تبليغ.getText()) {
            case "محضـر تبليــغ حكم غيابي":
                is = this.getClass().getResourceAsStream("/el_Mahadir/tablighe/Mahder_tabligh_7okm_ghiyabi/Mahder_tabligh_7okm_ghiyabi.jrxml");
                break;
            case "محضـر تبليـغ حكم غيابـي إبتـدائـي نهائـي":
                is = this.getClass().getResourceAsStream("/el_Mahadir/tablighe/Mahder_tabligh_7okm_ghiyabi_ibtidai_nihai/Mahder_tabligh_7okm_ghiyabi_ibtidai_nihai.jrxml");
                break;
            case "محضـر تبليـغ حكم غيابـي نهائـي":
                is = this.getClass().getResourceAsStream("/el_Mahadir/tablighe/Mahder_tabligh_7okm_ghiyabi_nihai/Mahder_tabligh_7okm_ghiyabi_nihai.jrxml");
                break;
        }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_7okm_ghiyabiController_1.class.getName()).log(Level.SEVERE, null, ex);
