 ...
 */
package el_Mahadir.tablighe.Mahder_tablighe_7ajz_tanfidi_wajard;

import el_Mahadir.tablighe.Mahder_tabligh_tasri7_Elta3n_biNNa9d.*;
import el_Mahadir.tablighe.Mahder_tabligh_9arar_ghiyabi.*;
import el_Mahadir.tablighe.Mahder_tabligh_Amre_Isti3jali.*;
 ...
 */
public class Mahder_tablighe_7ajz_tanfidi_wajardController_1 implements Initializable {
   ...
   // public Label lbl_الجدول;
    ...
    private void update_mahderTaklif(ActionEvent event) throws SQLException, JRException {
        ...
        if (isValidConditionModification()) {
            ...
            ps.setString(10, "لاشيء");// سكن المطلوب
            ps.executeUpdate();
            ps.close();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tablighe_7ajz_tanfidi_wajardController_1.class.getName()).log(Level.SEVERE, null, ex);
