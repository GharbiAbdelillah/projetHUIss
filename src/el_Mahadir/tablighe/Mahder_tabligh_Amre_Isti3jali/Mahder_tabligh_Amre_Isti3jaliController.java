 ...
 */
public class Mahder_tabligh_Amre_Isti3jaliController implements Initializable {
...
//                ps.setString(3, "محضـر تبليــغ حكم حضـوري");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_Amre_Isti3jaliController.class.getName()).log(Level.SEVERE, null, ex);
        }
