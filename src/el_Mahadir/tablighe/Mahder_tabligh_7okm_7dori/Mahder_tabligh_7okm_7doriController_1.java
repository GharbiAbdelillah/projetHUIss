 ...
 */
public class Mahder_tabligh_7okm_7doriController_1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_7okm_7doriController_1.class.getName()).log(Level.SEVERE, null, ex);
