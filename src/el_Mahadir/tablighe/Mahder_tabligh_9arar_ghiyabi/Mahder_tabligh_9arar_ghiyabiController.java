 ...
 */
public class Mahder_tabligh_9arar_ghiyabiController implements Initializable {
...
//                ps.setString(3, "محضـر تبليــغ حكم حضـوري");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Mahder_tabligh_9arar_ghiyabiController.class.getName()).log(Level.SEVERE, null, ex);
        }
